        ...
        <div className="flex flex-col gap-9">
          ...
          >
            <div className="space-y-6">
              {/* Estados Básicos */}
              <div>
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-300 mb-3">Estados Básicos</h3>
              ...
              {/* Con Iconos */}
              <div>
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-300 mb-3">Con Iconos</h3>
                <div className="flex flex-wrap gap-3">
                  <EtiquetaEstado 
                    texto="Completado" 
                    estado="exito" 
              ...
              {/* Diferentes Tamaños */}
              <div>
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-300 mb-3">Tamaños</h3>
              ...
              {/* Personalizados */}
              <div>
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-300 mb-3">Personalizados</h3>
                <div className="flex flex-wrap gap-3">
                  <EtiquetaEstado 
                    texto="Premium" 
              ...
              {/* Ancho Completo */}
              <div>
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-300 mb-3">Ancho Completo</h3>
