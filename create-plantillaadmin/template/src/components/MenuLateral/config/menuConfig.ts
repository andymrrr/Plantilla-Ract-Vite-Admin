...
// Función helper para obtener solo las secciones (compatibilidad con código existente)
export const getMenuSections = () => menuConfig.sections;

// Función helper para obtener configuración completa
export const getFullMenuConfig = () => menuConfig; 